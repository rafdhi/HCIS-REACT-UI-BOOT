...
const defaultDetail = {
    ...
    "payrollDetailStatus": true,
    "payrollComponentValue": ''
}

class FormCreatePayroll extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: { ...defaultDetail, payrollTPLDetailID: 'PAY-TPL-DETAIL-' + M() },
        }
    }
    ...
    render() {
        ...
        // console.log('bizparPayrollTplComponentType', (this.props.bizparPayrollTplComponentType))
                    ...
                    <div className="popup-panel grid grid-2x">
                        <div className="col-1">
                            <div className="popup-title">
                                Payroll Template Detail - Create Form
                            </div>
                        </div>
