...
class FormFeedBack extends Component {
  constructor(props) {
    ...
    this.state = {
      type: props.type,
      data: props.data ? props.data : { ...defaultPayload, feedbackPerformanceID: "CNCF-" + M() }
    }
  }
          ...
          <form action="#">
            <div className="border-bottom padding-15px">
              ...
              <div className="margin-bottom-20px">
                ...
                <DropDown
                  ...
                  type="bizpar"
                  data={this.props.bizparCncFeedbackType}
                  ...
                  value={data.feedbackType ? data.feedbackType.bizparKey ? data.feedbackType.bizparKey : data.feedbackType : ""}
                />
              </div>
            </div>
            ...
            <div className="border-top padding-15px content-right">
              ...
              <button
                ...
                type="button"
                onClick={() => {
                  if (R.isEmpty(data.feedbackType)) return alert("Component Type is Required.")
