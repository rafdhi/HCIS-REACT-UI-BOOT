...
class CreatePayroll extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: { ...defaultPayload, payrollTPLID: 'PAY-' + M() }
        }
    }
    ...
    render() {
        let { payrollTPLID } = this.state.data
        return (
                                    ...
                                    <div className="margin-bottom-20px">
                                        ...
                                        <div className="margin-5px">
                                            <p className="txt-site txt-11 txt-primary">
                                                The Payroll template menu is to be used to create salary calculation template.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="margin-bottom-20px">
