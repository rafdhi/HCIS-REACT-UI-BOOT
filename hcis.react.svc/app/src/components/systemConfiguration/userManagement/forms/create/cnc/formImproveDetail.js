          ...
          <form action="#">
            <div className="border-bottom padding-15px">
              ...
              <div className="margin-bottom-20px">
                ...
                <DropDown
                  ...
                  type="bizpar"
                  data={this.props.bizparCncImproveCatItem}
                  value={data.improveTargetComponent ? data.improveTargetComponent.bizparKey ? data.improveTargetComponent.bizparKey : data.improveTargetComponent : ""}
                  onChange={(e) => this.setState({
                    data: {
                      ...data,
                      improveTargetComponent: e
                    }
                  })}
                />
              </div>
            ...
            <div className="border-top padding-15px content-right">
              ...
              <button
                ...
                type="button"
                onClick={() => {
                  if (R.isEmpty(data.improveTargetComponent)) return alert("Component Name is Required.")
