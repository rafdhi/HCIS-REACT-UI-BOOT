...
class FormProAppraisalCompProcess extends Component {
  constructor(props) {
    super(props);
    this.state = {
      data: props.rawData ? props.rawData : { ...dataCreate, ocpvaItemID: 'COMP-APPRAISAL-' + M() }
    };
  }
            ...
            <div className="border-bottom padding-15px">
              ...
              <div className="margin-bottom-20px">
                ...
                <DropDown
                  ...
                  type="bizpar"
                  data={this.props.bizparPerformaceValue}
                  required
                  value={data.ocpvaItemComponent ? data.ocpvaItemComponent.bizparKey : ''}
                  onChange={e => this.setState({ data: { ...data, ocpvaItemComponent: e } })}
                />
              </div>
            </div>
...
export default FormProAppraisalCompProcess;
