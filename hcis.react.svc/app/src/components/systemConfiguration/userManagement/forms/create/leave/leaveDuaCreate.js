...
class LeaveDuaCreate extends Component {
    constructor(props) {
        super(props)
        this.state = {
                    ...
                    <form action="#">
                        <div className="a-s-p-mid a-s-p-pad">
                            <div className="margin-bottom-5px display-flex-normal padding-15px border-bottom">
                                ...
                                <h1 className="txt-site txt-18 txt-main ">Leave Template Header</h1>
                            </div>
