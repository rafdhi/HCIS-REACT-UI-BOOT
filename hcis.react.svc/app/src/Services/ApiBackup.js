...
const create = (type = '') => {
	...
	switch (type) {
		...
		case 'RECRUITMENT':
			api = apisauce.create({
				baseURL: "http://recruitmentcmd:60013/",
				headers: {
					'Cache-Control': 'no-cache',
					Accept: 'application/json',
					'Content-Type': 'application/json',
		...
		case 'RECRUITMENT_QUERY':
			api = apisauce.create({
				baseURL: "http://recruitmentqry:60014/",
				headers: {
					'Cache-Control': 'no-cache',
					Accept: 'application/json',
					'Content-Type': 'application/json',
