...
class FormCrime extends Component {
    constructor(props) {
        super(props)
                        ...
                        <div className="col-1">
                            <div className="popup-title">
                                {this.props.type === "create"
                                    ? "Crime Record – Create Form"
                                    : this.props.type === "update"
                                        ? "Crime Record – Edit Form"
                                        : "Crime Record – View Form"}
                            </div>
                        </div>
                                ...
                                <div className="margin-bottom-20px">
                                    <div className="margin-5px">
                                        <div className="txt-site txt-11 txt-main txt-bold">
                                            <h4>Criminal ID <span style={{ color: "red" }}>*</span></h4>
                                        </div>
                                    </div>
                                    <input
                                        readOnly
