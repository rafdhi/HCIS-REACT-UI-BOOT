...
class formInformalEducation extends Component {
  constructor(props) {
    super(props);
      ...
      <div className={"app-popup app-popup-show"}>
        ...
        <div className="popup-content background-white border-radius">
            ...
            <div className="col-1">
              <div className="popup-title">
                {this.props.type === "create"
                  ? "Applicant Detail - Informal Education - Create Form"
                  : this.props.type === "update"
                    ? "Applicant Detail - Informal Education - Edit Form"
                    : "Applicant Detail - Informal Education - View Form"}
              </div>
            </div>
          ...
          <form action="#"
            onSubmit={(e) => {
              e.preventDefault()
              if (!R.isEmpty(this.state.applicantDataInformEdu.informalEducationStartDate) && !R.isEmpty(this.state.applicantDataInformEdu.informalEducationEndDate) && (this.state.applicantDataInformEdu.informalEducationEndDate < this.state.applicantDataInformEdu.informalEducationStartDate)) return alert('End Date Should be Greater Than Start Date.')
              if (R.isEmpty(this.state.applicantDataInformEdu.informalEducationStartDate) || R.isEmpty(this.state.applicantDataInformEdu.informalEducationEndDate)) return alert('Date is Required.')
              if (R.isEmpty(this.state.applicantDataInformEdu.informalEducationTrainingType) || R.isEmpty(this.state.applicantDataInformEdu.informalEducationTrainingType.bizparKey)) {
                return alert('Training Type is Required.')
              }
              if (this.state.applicantDataInformEdu.informalEducationTrainingType.bizparKey === "TRATYP-002") {

                if (R.isEmpty(this.state.applicantDataInformEdu.informalEducationCertificateDate) || R.isNil(this.state.applicantDataInformEdu.informalEducationCertificateDate)) return alert('Date of Certificate is Required.')
                if (R.isEmpty(this.state.applicantDataInformEdu.informalEducationCostSource) || R.isEmpty(this.state.applicantDataInformEdu.informalEducationCostSource.bizparKey)) {
                  return alert('Cost of Education is Required.')
                }
                this.props.onClickSave(this.state.applicantDataInformEdu)
              }
...
export default formInformalEducation;
