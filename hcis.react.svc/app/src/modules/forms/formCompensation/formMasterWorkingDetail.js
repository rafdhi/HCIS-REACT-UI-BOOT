...
import FormMasterWorkingDetailCreate from './formMasterWorkingDetailCreate'

var ct = require("../../../modules/custom/customTable")
const getMuiTheme = () => createMuiTheme(ct.customTable());
const options = ct.customOptions()

class FormMasterWorkingDetail extends Component {
    constructor(props) {
        super(props)
        this.state = {
            createVisible: false,
    ...
    data = [["1", "1", "TETAP", "Allocation Allowance"], ["2", "1", "TETAP", "Attendance Allowance"]]
...
export default FormMasterWorkingDetail