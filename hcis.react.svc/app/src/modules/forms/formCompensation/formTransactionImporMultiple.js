...
import FormTransactionImporMUpload from './formTransactionImporMUpload'
import FormTransactionImporMDetail from './formTransactionImporMDetail'

var ct = require("../../../modules/custom/customTable")
const getMuiTheme = () => createMuiTheme(ct.customTable())
const options = ct.customOptions()

class FormTransactionImporMultiple extends Component {
    constructor(props) {
        super(props)
        this.state = {
...
export default FormTransactionImporMultiple