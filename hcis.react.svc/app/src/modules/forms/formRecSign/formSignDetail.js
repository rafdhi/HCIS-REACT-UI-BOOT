...
class FormSignDetail extends Component {
    constructor(props) {
        super(props)
        this.state = {
                        ...
                        <div className="column-1">
                                ...
                                <div className="margin-bottom-20px">
                                    ...
                                    {/* <select
                                        ...
                                        disabled={this.props.type !== "create1" ? true : false}
                                        style={
                                            this.props.type !== "create1"
                                                ? { backgroundColor: "#E6E6E6" }
                                                : null
                                        }
                                        required
                                    >
                                        <option value="1">-- please select Recruitment Type --</option>
                                ...
                                <div className="margin-bottom-20px">
                                    ...
                                    {/* <select
                                        ...
                                        required
                                    >
                                        <option value="1">-- please select Recruitment Category --</option>
                                        <option value="1">1</option>
                                    </select> */}
                                </div>
                                <div className="margin-bottom-20px">
                        ...
                        <div className="column-2">
                            <div className="margin-bottom-20px">
                                ...
                                <div className="margin-bottom-20px">
                                    ...
                                    {/* <input
                                        type="date"
                                        readOnly={this.props.type !== 'create1' ? true : false}
                                        style={
                                            this.props.type !== "create1"
                                                ? { backgroundColor: "#E6E6E6" }
                                                : null
