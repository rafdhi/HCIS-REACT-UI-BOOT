...
class FormOutsourceEdit extends Component {
  constructor(props) {
    super(props);
    this.state = {
              ...
              <div className="col-1">
                <div className="popup-title">
                  {this.props.type === "create"
                    ? "User Assessment - Create Form"
                    : this.props.type === "edit"
                    ? "User Assessment - Edit Form"
                    : "User Assessment - View Form"}
                </div>
              </div>
                ...
                <div className="margin-bottom-5px">
                  ...
                  {/* <input
                                        ...
                                        style={this.props.type === "view" ? {  backgroundColor: "#E6E6E6"}:
                                                this.props.type === "edit" ? { width: "50%"}:null}
                                            className="txt txt-sekunder-color"
                                            type="date"
                                            placeholder=""
                                        >
              ...
              <div className={this.state.detailClass}>
                ...
                >
                  <div className="popup-panel">
                    <div className="popup-title">
                      User Assessment - Edit Detail Form
                    </div>
                  </div>
...
export default FormOutsourceEdit;
