...
import FormAdjustmentHistory from "./formAdjustmentHistory";
import FormOutstandingGeneral from "./formOutstandingGeneral";

var ct = require("../../../modules/custom/customTable");
const getMuiTheme = () => createMuiTheme(ct.customTable());
const options = ct.customOptions();

class FormOutstanding extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default FormOutstanding;
